  ...
  public: {
    Tables: {
      ...
      challenge_applications: {
        ...
        Relationships: [
          {
            foreignKeyName: "challenge_applications_applicant_id_fkey"
          ...
          {
            foreignKeyName: "challenge_applications_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
      ...
      facilities: {
        ...
        Relationships: [
          {
            foreignKeyName: "facilities_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: true
            referencedRelation: "stores"
            referencedColumns: ["id"]
      ...
      store_bookmarks: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_bookmarks_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
